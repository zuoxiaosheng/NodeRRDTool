...
function RRA(rrd_data, rra_ptr_idx, rra_info, header_size, prev_row_cnts, ds_cnt) {
    ...
    RRA.prototype.getEl = function(row_idx, ds_idx) {
        return this.rrd_data.getDoubleAt(this.base_rrd_db_idx + this._calculateIndexes(row_idx, ds_idx));
    }

    // // Low precision version of getEl
    // // Uses getFastDoubleAt
    // RRA.prototype.getElFast = function(row_idx,ds_idx) {
    //     return this.rrd_data.getFastDoubleAt(this.base_rrd_db_idx + this._calculateIndexes(row_idx,ds_idx));
    // }
